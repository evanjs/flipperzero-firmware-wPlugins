...
const char* blockName(uint8_t blockId) {
    switch (blockId) {
        ...
        case BLOCK_COBBLE:  return "Cobblestone";
        case BLOCK_LOG:     return "Wood Log";
        case BLOCK_LEAVES:  return "Leaves";
        case BLOCK_PLANK:   return "Planks";
        case BLOCK_COALORE: return "Coal Ore";
        case BLOCK_IRONORE: return "Iron Ore";
        case BLOCK_SAND:    return "Sand";
        case BLOCK_GLASS:   return "Glass";
        case BLOCK_SAPLING: return "Sapling";
        case BLOCK_TABLE:   return "Crafting Table";
